 ...
 * File: robocar_pp.c
 *
 * Code generated for Simulink model 'robocar_pp'.
 *
 * Model version                  : 2.40
 * Simulink Coder version         : 24.2 (R2024b) 21-Jun-2024
 * C/C++ source code generated on : Fri Nov 29 00:40:07 2024
 *
...
void robocar_pp_step(void)
{
  ...
  if (!searchFlag) {
    rtDW.obj.WaypointsInternal[0] = 5.0;
    rtDW.obj.WaypointsInternal[1] = 50.0;
    rtDW.obj.WaypointsInternal[2] = 5.0;
    rtDW.obj.WaypointsInternal[3] = 50.0;
  ...
  if (tmp_size_idx_0 == 0) {
    ...
    if (rtDW.obj.ProjectionLineIndex == 0.0) {
      ...
      rtDW.obj.ProjectionPoint[1] = rtb_path[tmp_data[0] + 2];
    ...
    if (tmp_size_idx_0 == 1) {
      ...
      lookaheadEndPt_idx_1 = rtb_path[tmp_data[0] + 2];
      ...
      lookaheadStartPt[1] = rtb_path[b_k + 2];
      ...
      rtb_path_0[1] = lookaheadStartPt[1] - (real_T)rtb_path[tmp_data[(int32_T)
        (rtDW.obj.ProjectionLineIndex + 1.0) - 1] + 2];
      dist = norm(rtb_path_0);
      lookaheadIdx = rtDW.obj.ProjectionLineIndex + 1.0;
      b_k = (int32_T)((1.0 - (rtDW.obj.ProjectionLineIndex + 1.0)) + 1.0) - 1;
      trueCount = 0;
      exitg1 = false;
      while ((!exitg1) && (trueCount <= b_k)) {
        ...
        if ((!searchFlag) && (dist > rtDW.obj.LookaheadDistance)) {
          ...
          rtb_path_tmp = rtb_path[tmp_data[1]];
          tmp_size_idx_0 = tmp_data[(int32_T)lookaheadEndPt_idx_0 - 1];
          rtb_path_tmp_0 = rtb_path[tmp_size_idx_0];
          rtb_path_0[0] = rtb_path_tmp_0 - rtb_path_tmp;
          lookaheadStartPt[0] = rtb_path_tmp;
          rtb_path_1[0] = rtb_path_tmp_0;
          rtb_path_tmp = rtb_path[tmp_data[1] + 2];
          rtb_path_tmp_0 = rtb_path[tmp_size_idx_0 + 2];
      ...
      lookaheadEndPt_idx_1 = rtb_path[b_k + 2];
      ...
      while ((minDistance < 0.0) && (lookaheadIdx < 1.0)) {
        lookaheadIdx++;
        b_k = tmp_data[(int32_T)lookaheadIdx - 1];
        rtb_path_tmp = rtb_path[b_k];
        lookaheadStartPt[0] = rtb_path_tmp;
        rtb_path_tmp_0 = rtb_path[tmp_data[1]];
        lookaheadEndPt_idx_0 = rtb_path_tmp_0;
        rtb_path_0[0] = rtb_path_tmp - rtb_path_tmp_0;
        rtb_path_tmp = rtb_path[b_k + 2];
        lookaheadStartPt[1] = rtb_path_tmp;
        rtb_path_tmp_0 = rtb_path[tmp_data[1] + 2];
...
void robocar_pp_initialize(void)
{
  ...
  rtDW.obj.WaypointsInternal[0] = (rtNaN);
  rtDW.obj.WaypointsInternal[1] = (rtNaN);
  rtDW.obj.WaypointsInternal[2] = (rtNaN);
  rtDW.obj.WaypointsInternal[3] = (rtNaN);
