...
## Generated on : Fri Nov 29 00:36:29 2024
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/robocar_pp_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=robocar_pp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/robocar_pp_ert_rtw/robocar_pp.c

MAIN_SRC = $(START_DIR)/robocar_pp_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/robocar_pp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/robocar_pp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/robocar_pp_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/robocar_pp_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/robocar_pp_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/robocar_pp_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


robocar_pp.o : $(START_DIR)/robocar_pp_ert_rtw/robocar_pp.c
	$(CC) $(CFLAGS) -o "$@" "$<"
