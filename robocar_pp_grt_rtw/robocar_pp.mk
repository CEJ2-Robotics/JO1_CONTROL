###########################################################################
## Makefile generated for component 'robocar_pp'. 
## 
## Makefile     : robocar_pp.mk
## Generated on : Wed Nov 13 20:12:45 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/robocar_pp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/robocar_pp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/robocar_pp_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=robocar_pp -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/robocar_pp_grt_rtw/robocar_pp.c $(START_DIR)/robocar_pp_grt_rtw/robocar_pp_data.c $(START_DIR)/robocar_pp_grt_rtw/rtGetInf.c $(START_DIR)/robocar_pp_grt_rtw/rtGetNaN.c $(START_DIR)/robocar_pp_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.o robocar_pp.o robocar_pp_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/robocar_pp_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/robocar_pp_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/robocar_pp_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/robocar_pp_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/robocar_pp_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
robocar_pp.o : $(START_DIR)/robocar_pp_grt_rtw/robocar_pp.c
	$(CC) $(CFLAGS) -o "$@" "$<"


robocar_pp_data.o : $(START_DIR)/robocar_pp_grt_rtw/robocar_pp_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/robocar_pp_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/robocar_pp_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/robocar_pp_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
